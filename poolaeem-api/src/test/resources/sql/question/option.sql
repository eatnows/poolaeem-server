...
values ('option-1', 'problem-1', '단어', true, 1, false, 'user-1', 'user-1', '2023-07-09 22:40:31.612',
       ...
       ('option-9', 'problem-4', '프린터', false, 1, false, 'user-2', 'user-2', '2023-07-10 15:01:22.223',
        '2023-07-10 15:01:22.223'),
       ('option-10', 'problem-4', '컴퓨터', true, 2, false, 'user-2', 'user-2', '2023-07-10 15:01:22.224',
        '2023-07-10 15:01:22.224')
;
